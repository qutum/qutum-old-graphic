...
Toolbar = function (edit, dom1, dom2)
{
	...
	com(dom1, 'd', 'Add sibling nonput Datum', 'd', edit.com.datum, false)
	com(dom1, 'o', 'Add sibling Output', 'o', edit.com.output, false)
	com(dom1, 'I', 'Add inner Input', 'I', edit.com.input, true)
	com(dom1, 'D', 'Add inner nonput Datum', 'D', edit.com.datum, true)
	...
	foc(dom2, 'tab', 'Inner Input, nonput Datum or Output', 'tab or space', edit.focInner)
	foc(dom2, ',', 'Inner Input', ',', edit.focInput)
	foc(dom2, '`', 'Inner nonput Datum', '`', edit.focDatum)
	foc(dom2, '.', 'Inner Output', '.', edit.focOutput)
	foc(dom2, ';', 'Next Unity', ';', edit.focUnity, false)
	foc(dom2, ':', 'Previous Unity', ':', edit.focUnity, true)
